## [改訂新版] Android SDK ポケットリファレンス 重村浩二 技術評論社
### Chapter03 UI
#### ui_DatePickerDialog 日付ピッカーダイアログを表示する p.144
コンストラクタで指定するyear monthOfYear, dayOFMonthで、ダイアログ表示時の日付を初期化します。  
日付設定のonDateSetメソッド以外については、ダイアログフラグメントの説明を参照して下さい。
#### Links
